...
## Character Class System: (WIP)
This small system is about a player having multiple classes that contain different attributes and abilities

# Future Work:

In the future, I would like to take some of these and implement them outside of Unity. Systems like the room system have been around for a long time, so they don't require complex engines to support them. 
